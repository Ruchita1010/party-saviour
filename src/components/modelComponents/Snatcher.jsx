...
Command: npx gltfjsx@6.1.4 -T Snatcher.glb
*/

import React, { useRef } from 'react';
import { useGLTF, useAnimations } from '@react-three/drei';
import SnatcherModel from '../../assets/models/Snatcher.glb';

export function Snatcher(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(SnatcherModel);
